...
BuildRequires:  python27-futures >= 2.0
BuildRequires:  python27-markupsafe
BuildRequires:  python27-msgpack > 0.3
...
BuildRequires:  python27-ioflo >= 1.1.7
...
BuildRequires:  python27-salt-testing >= 2015.2.16
BuildRequires:  python27-unittest2
BuildRequires:  python27-xml
%endif
%if %{with docs}
#for docs
BuildRequires:  python27-sphinx10
%endif
...
Requires:       python27-CherryPy >= 3.2.2
...
Group:          System/Monitoring
Requires:       %{name} = %{epoch}:%{version}
Requires:     python27-pygit2 >= 0.20.3
%ifarch %{ix86} x86_64
%if 0%{?suse_version}
Requires:       dmidecode
%endif
...
Requires:       python27-ioflo >= 1.1.7
Requires:       python27-libnacl >= 1.0.0
Requires:       python27-raet >= 0.6.0
...
%dir               %attr(0750, root, salt) %{_sysconfdir}/salt/pki/master/
%dir               %attr(0750, root, salt) %{_sysconfdir}/salt/pki/master/minions/
%dir               %attr(0750, root, salt) %{_sysconfdir}/salt/pki/master/minions_autosign/
%dir               %attr(0750, root, salt) %{_sysconfdir}/salt/pki/master/minions_denied/
%dir               %attr(0750, root, salt) %{_sysconfdir}/salt/pki/master/minions_pre/
%dir               %attr(0750, root, salt) %{_sysconfdir}/salt/pki/master/minions_rejected/
%dir               %attr(0755, root, salt) /srv/salt
%dir               %attr(0755, root, salt) /srv/pillar
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/jobs/
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/proc/
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/queues/
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/roots/
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/syndics/
%dir               %attr(0750, root, salt) %{_localstatedir}/cache/salt/master/tokens/
